...
/// Бриф клиента — пожелания, которые мы собираем перед расчётами.
///
/// Заполняется через многошаговый визард и автосохраняется после каждого
/// шага. На основе брифа движок правил подбирает состав сооружения.
class ClientBrief {
  ...
  /// Все ключевые поля заполнены (готовый бриф).
  bool get isComplete =>
      region != null &&
      snowZone != null &&
      windZone != null &&
