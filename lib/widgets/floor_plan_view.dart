...
///
/// Дверные и оконные проёмы (СП 55.13330, СП 1.13130) рисуются поверх:
      ...
      child: Container(
        ...
        child: CustomPaint(
          painter: FloorPlanPainter(
            ...
            roomFill: theme.colorScheme.primaryContainer.withOpacity(0.50),
            staircaseFill:
...
class FloorPlanPainter extends CustomPainter {
  ...
  void _drawOpening(
    ...
    if (isVerticalWall) {
      // Стена вертикальная: проём от (o.x - t/2, o.y) шириной t, высотой length.
      openingRectM = Rect.fromLTWH(
        o.x - thickness / 2,
        o.y,
        thickness,
        o.length,
    ...
    if (o.kind == OpeningKind.window) {
      ...
      // вдоль стены (стандартный CAD-символ окна, СП 50.13330).
    ...
    final arcPaint = Paint()
      ..color = doorColorEff.withOpacity(0.55)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 0.8;
