...
class AppState extends ChangeNotifier {
  ...
  /// на основе брифа. Перетирает текущий выбор по фундаменту/стенам/крыше.
  ///
  /// Используется в режиме «Клиент» автоматически после сохранения брифа,
  ...
  Future<void> regenerateDrawings(HouseProject project) async {
    final mode = _mode ?? UserMode.client;
    final batch = DrawingGenerator.generate(project: project, mode: mode);
