...
class _SideMenu extends StatelessWidget {
  ...
  void _showAbout(BuildContext context) {
    showAboutDialog(
      context: context,
      applicationName: 'Калькулятор проектировщика',
      applicationVersion: 'beta',
      applicationLegalese:
          'Расчёты по СП 20/22/63. Чертежи в PDF/DXF. Все данные — локально '
          'в браузере. Веб‑демо: scrim4344-droid.github.io/construction-calculator',
    );
  }
}
